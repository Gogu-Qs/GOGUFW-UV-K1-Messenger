...
enum ACTION_OPT_t {
    ...
    ACTION_OPT_FM = 7,
    ACTION_OPT_1750 = 8,
    ACTION_OPT_KEYLOCK = 9,
    ACTION_OPT_A_B = 10,
    ACTION_OPT_VFO_MR = 11,
    ACTION_OPT_SWITCH_DEMODUL = 12,
    ACTION_OPT_BLMIN_TMP_OFF = 13, //BackLight Minimum Temporay OFF
    ACTION_OPT_RXMODE = 14,
    ACTION_OPT_MAINONLY = 15,
    ACTION_OPT_PTT = 16,
    ACTION_OPT_WN = 17,
    ACTION_OPT_BACKLIGHT = 18,
    ACTION_OPT_MUTE = 19,
    ACTION_OPT_RXA = 20,
    ACTION_OPT_POWER_HIGH = 21,
    ACTION_OPT_REMOVE_OFFSET = 22,

    /* Persistent key-action IDs.  Keep the removed Beam slot reserved so
     * Messenger/HEARD/CALLTX remain compatible with EEPROM and CHIRP. */
    ACTION_OPT_BEAM = 23,
    ACTION_OPT_MESSENGER = 24,
    ACTION_OPT_HEARD = 25,
    ACTION_OPT_CALLTX = 26,
    ACTION_OPT_RF_LOG = 27,
#ifdef ENABLE_REGA
    ACTION_OPT_REGA_ALARM = 28,
    ACTION_OPT_REGA_TEST = 29,
    ACTION_OPT_LEN = 30
#else
    ACTION_OPT_LEN = 28
#endif
