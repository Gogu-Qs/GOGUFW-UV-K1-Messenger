...
_Static_assert(MB_SLOT0_EXT_BASE + MB_SLOT_COUNT * MB_SLOT_STRIDE ==
               MB_PROFILE1_EXT_BASE,
               "multiboot slots overlap profile banks");
_Static_assert(MB_PROFILE1_EXT_BASE +
               (MB_PROFILE_COUNT - 1u) * MB_PROFILE_BANK_SIZE ==
               MB_PROFILE_STATE_A_BASE,
               "multiboot profile banks overlap marker");
_Static_assert(MB_PROFILE_STATE_B_BASE + 0x1000u <= 0x0014C000u,
               "multiboot marker overlaps stock voice data");
