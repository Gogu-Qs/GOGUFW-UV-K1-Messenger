 ...
 *
 * The external-flash layout used by the guest is documented below.
 */
...
/*   0x102000  higher shared/reserved regions (do not allocate blindly)       */
/*   0x14C000  stock voice tables/audio begin              ] shared           */
/*                                                                            */
/* Banks are 64 KiB for headroom; standard config ends at 0x00A170 and GOGUFW */
/* owns bank offsets 0xB000..0xCFFF. Keep banks past the last slot if the slot */
/* count ever grows; all later voice/reserved regions remain shared.           */
